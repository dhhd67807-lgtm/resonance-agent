...
Void separately records basic usage like the number of messages people are sending. If you'd like to disable Void metrics, you may do so in Resonance Settings.
`;
