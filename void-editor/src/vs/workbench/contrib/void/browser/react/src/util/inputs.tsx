...
export type BlockCodeProps = { initValue: string, language?: string, maxHeight?: number, showScrollbars?: boolean, noBg?: boolean }
export const BlockCode = ({ initValue, language, maxHeight, showScrollbars, noBg }: BlockCodeProps) => {
